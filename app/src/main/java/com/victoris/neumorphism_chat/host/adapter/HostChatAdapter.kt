package com.victoris.neumorphism_chat.host.adapter
...
class HostChatAdapter(
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        when (holder.itemViewType) {
            // if sender is user
            0 -> {
                val yourViewHolder = holder as HostChatAdapter.YourViewHolder
            ...
            // if sender is other
            1 -> {
                val otherViewHolder = holder as HostChatAdapter.OtherViewHolder
